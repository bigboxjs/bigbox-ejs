...
function searchDir(dir) {
	var paths = FSUtile.readdirSync(dir);
...
function toJSON(path) {
	// 读取文件内容
	var buffer = FSUtile.readFileSync(path);
	...
	// 写入到新文件中
	FSUtile.writeFileSync(path + ".js", "module.exports = " + JSON.stringify(json) + ";", {
		flag: "w"
	});
}
